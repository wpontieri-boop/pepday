// Executa B2.2-D2-C em PostgreSQL efemero; nunca conecta ao Supabase.
...
try {
  ...
  currentFile = 'supabase/tests/block_b22d2c_update_routines.sql';
  await db.exec(await read(currentFile));

  // Regressao D2-B no schema final D2-C.
  ...
  await db.exec(`insert into auth.users(id,email) values
      ('d2a00000-0000-4000-8000-000000000001','d2a-after-d2c@example.invalid'),
      ('d1f00000-0000-4000-8000-000000000001','d1-after-d2c@example.invalid');
    insert into public.vials(id,user_id,name,initial_mg,remaining_mg,water_ml,prepared_on) values
      ('d2a00000-0000-4000-8000-000000000002','d2a00000-0000-4000-8000-000000000001',
        'D2-A apos D2-C',10,10,2,date '2026-09-25'),
      ('d1f00000-0000-4000-8000-000000000002','d1f00000-0000-4000-8000-000000000001',
        'D1 apos D2-C',10,10,2,date '2026-09-25');
    ...
    values('d2a00000-0000-4000-8000-000000000003','d2a00000-0000-4000-8000-000000000001',
      'd2a00000-0000-4000-8000-000000000002','Rotina D2-A apos D2-C',1,'mg',100,
  ...
  console.log('PASS: B2.2-D2-C e regressoes D2-B, D2-A, D1, B2.1, B1 e importacao legada.');
} catch (error) {
